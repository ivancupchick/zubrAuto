...
const change_log_controller_1 = require("./change-log.controller");
...
exports.ChangeLogModule = ChangeLogModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [change_log_controller_1.ChangeLogController],
        providers: [change_log_service_1.ChangeLogService],
        exports: [change_log_service_1.ChangeLogService]
    })
], ChangeLogModule);
