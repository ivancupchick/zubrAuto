...
export class CreateCarShowingComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.statuses = [
      ...
      {
        value: CarStatistic.ShowingStatus.plan,
        key: CarStatistic.ShowingStatus.plan,
      },
      {
        value: CarStatistic.ShowingStatus.success,
        key: CarStatistic.ShowingStatus.success,
      },
      {
        value: CarStatistic.ShowingStatus.cancel,
        key: CarStatistic.ShowingStatus.cancel,
      },
    ];
  ...
  create() {
    ...
    const methodObs = this.statiscticItem
      ? this.carService.updateCarShowing(
          this.selectedCarId,
          this.statiscticItem.id,
          {
